...
Feature: Test the  success status of latest Foreign  Exchange rates api
    ...
    @tag1
	  Scenario: Assert the success status of Latest foreign exchange rate api response
    Given Rates API for the Latest Foreign Exchange rates
    When The API is Available
    Then verify the status code of response success
   
   @tag2
    Scenario: Assert the success status of response of Latest foreign Exhange with symbol
   ...
   @tag3
   Scenario: Assert the success status of response of Latest foreign Exhange with base
   ...
   @tag4
   Scenario: Assert the success status of response of Latest foreign Exhange with symbol and base 
